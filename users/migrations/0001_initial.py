...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('clash_of_clans_username', models.CharField(blank=True, max_length=100, null=True)),
                ('clash_of_clans_trophies', models.IntegerField(blank=True, null=True)),
                ('call_of_duty_username', models.CharField(blank=True, max_length=100, null=True)),
                ('call_of_duty_kd_ratio', models.FloatField(blank=True, null=True)),
                ('chess_com_username', models.CharField(blank=True, max_length=100, null=True)),
                ('chess_com_rating', models.IntegerField(blank=True, null=True)),
                ('pubg_username', models.CharField(blank=True, max_length=100, null=True)),
                ('pubg_wins', models.IntegerField(blank=True, null=True)),
